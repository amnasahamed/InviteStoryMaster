...
const config: InvitationConfig = {
  ...
  details: {
    ...
    reception: {
      title: "The Reception",
      venue: "The Ivory Hall, Rosewood Estate",
      time: "6:30 PM — Midnight",
      note: "Dinner, toasts & dancing under the fairy lights",
    },
  ...
  calendar: {
    ...
    description:
      "Wedding ceremony at Rosewood Garden Chapel, followed by reception at The Ivory Hall.",
    durationHours: 8,
  },
  music: {
    src: "",
  ...
  footer: {
    ...
    copyright: "© 2026 Amelia & James · Handcrafted with love",
  },
}
