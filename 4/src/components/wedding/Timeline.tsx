import { Sun, Moon, Utensils, Sparkles, Camera, Cake, Heart } from "lucide-react";
import type { LucideIcon } from "lucide-react";

import { useReveal } from "./useReveal";

const STOPS = [
  { icon: Sun, label: "We'll meet here", time: "3:00 pm" },
  { icon: Moon, label: "Nikah", time: "3:30 pm" },
  { icon: Utensils, label: "Family Lunch", time: "4:30 pm" },
  { icon: Sparkles, label: "Reception", time: "6:00 pm" },
  { icon: Camera, label: "Photo Booth", time: "7:30 pm" },
  { icon: Cake, label: "Cake", time: "8:30 pm" },
  { icon: Heart, label: "See you", time: "till late" },
];
