...
/** Wedding day, 12 Dec 2026, 3:00 pm – 11:00 pm IST (UTC+05:30). */
const EVENT = {
  title: "Amaan & Fatima — Wedding",
  start: "20261212T093000Z",
  end: "20261212T173000Z",
  location: "Noor Bagh, Masjid-e-Noor & Garden Lawns, Banjara Hills, Hyderabad",
  details:
    "Nikah 3:30 pm · Family lunch 4:30 pm · Reception 6:00 pm · Photo booth 7:30 pm · Cake 8:30 pm. We can't wait to see you there.",
} as const;
