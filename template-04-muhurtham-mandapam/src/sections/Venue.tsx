...
import { googleMapsUrl, whatsappUrl } from "@/lib/calendar";
      ...
      <div className="relative mx-auto max-w-md">
        ...
        <Reveal delay={0.2} className="mt-12 text-center">
          ...
          <p className="mx-auto mt-2 max-w-xs text-[13px] leading-relaxed text-[#5a4632]">
            Kindly RSVP so we can reserve your seat at the muhurtham and a plate at the feast.
          </p>
          <a
            href={whatsappUrl()}
            target="_blank"
            rel="noreferrer"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-to-b from-[#2e7d43] to-[#1f5c30] px-8 py-3.5 text-[12px] font-semibold uppercase tracking-[0.22em] text-[#eef7ef] shadow-[0_10px_24px_-10px_rgba(31,92,48,0.8)] transition-transform active:scale-95"
          >
